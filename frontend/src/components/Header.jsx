...
// my requirement- below code is signup, if a user comes he enters his all details like first name, last name etc but also email,mobile number,But when his relative comes he gives his firstname,last name  and other details but similar email and mobile number of previous user or if gives any one detail similar to previous user.I want to make him signup as well.Correct code
// as per out previous chat, and as per my requirement, code is not working correct. I have a column name UniqueCombination in appwrite to check if existing user came by filling all 4 details same->firstname,last name, email, mobile number, but in appwrite it is showing null.Write logic for that and also use that to check if user already exists.
